...
public class FlatButton extends Button {
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        ...
        try {
            /**决定控件的圆角*/
            float defValue = getDimension(R.dimen.dp_2);
    ...
    private LayerDrawable createNormalDrawable(TypedArray attr) {
        ...
        int blueDark = getColor(R.color.colorGreen);//按钮下progress的颜色
//        int blueDark = getColor(R.color.colorGreen);
        ...
        int blueNormal = getColor(R.color.colorGreen);//按钮的上面的颜色
