...
public class ViewFlow extends AdapterView<Adapter> {
	...
	private IInterceptTouchEvent mInterceptTouchEvent;

	public void setOnInterceptTouchEvent(IInterceptTouchEvent event){
		mInterceptTouchEvent= event;
	}
	...
	public interface IInterceptTouchEvent{
		public void onSetParentSrcollable(MotionEvent event);
	}
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		if(mInterceptTouchEvent!=null){
			mInterceptTouchEvent.onSetParentSrcollable(ev);
		}
...
//				}
	...
	private void snapToDestination() {
		...
		Log.d("ViewFlow", "scrollX:"+scrollX);
		final int whichScreen = (int)(getScrollX() + screenWidth/2)
				/ screenWidth;
