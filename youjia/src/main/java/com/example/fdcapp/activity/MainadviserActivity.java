...
public class MainadviserActivity extends AbsSubActivity {
	ImageView uhead_iv;
	...
	private void findID() {
		uhead_iv = (ImageView) findViewById(R.id.head_amain_iv);
		uName_tv = (TextView) findViewById(R.id.name_amain_tv);
		fName_tv = (TextView) findViewById(R.id.fname_amain_tv);
	}
